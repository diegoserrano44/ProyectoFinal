...
<main class="container-fluid mainContainer">
	<div class="container bg-light border-2 border-dark rounded-3 pt-4 pb-5 px-5 shadow loginContainer">
		<h1 class="text-center fw-bold mt-3 mb-4">Welcome</h1>
		<?php
		...
		<form class="needs-validation" method="POST" action="index.php?ctl=entrarUsuario" novalidate>
			<div class="has-validation mt-3 mb-4">
				<label for="Luser" class="form-label fw-bold mb-3 text-dark">Username</label>
			...
			<div class="has-validation mt-3 mb-4">
				<label for="Lpass" class="form-label fw-bold mb-3 text-dark">Password</label>
				<input type="password" class="form-control" name="Lpass" id="Lpass" required>
				<div class="invalid-feedback">
					Please provide a password.
				</div>
			</div>
			<button class="btn my-3 w-100 py-2 fw-bold botonAzul" type="submit" name="login">Login</button>		
			<?php if($login_button != ""){echo $login_button; }?>	
		</form>
			<a href="index.php?ctl=enviarPass" >I forgot my password, send me a new one</a>
	</div>
</main>
