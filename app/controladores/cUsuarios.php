...
class cUsuarios
{
    ...
    public function entrarUsuario()
    {
        ...
        if (isset($_GET["code"])) {
            ...
            $login_button = '<a class="btn my-3 w-100 py-2 btn-lg btn-google btn-block text-uppercase btn-outline-white" href="' . $google_client->createAuthUrl() . '"><img src="https://img.icons8.com/color/54/000000/google-logo.png"> Inicia Sesión con Google</a>';
        }
