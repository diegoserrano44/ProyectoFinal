...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-04-2022 a las 16:13:15
...
(1, 'general', 'Aquí es para hablar de temas generales'),
(2, 'deportes', 'Aquí es para hablar de deportes');
...
(65, 1, 67, 68, 67, 'Ajax', 'Aló María OwO', '2022-02-15 19:21:12', 1, 0),
(66, 2, 67, 68, 67, 'Clases de Python', 'Buenas, me interesarían las clases de Python.', '2022-02-15 19:25:11', 1, 1),
(67, 3, 68, 67, 68, 'Clases de angular', 'Hola, estaría interesada en las clases. ¿Las haces también en valenciano?\r\nGracias', '2022-02-15 19:25:59', 0, 0),
(68, 4, 68, 67, 68, 'Clases de angular', 'Hola, estaría interesada en las clases. ¿Las haces también en valenciano? Gracias', '2022-02-15 19:26:39', 1, 1),
(69, 4, 67, 67, 68, 'Clases de angular', 'Sí, también doy mis clases en valenciano :)', '2022-02-15 19:27:35', 1, 1),
(70, 2, 68, 68, 67, 'Clases de Python', 'Genial, ¿cuándo quieres empezar?', '2022-02-15 19:28:02', 1, 1),
(71, 4, 68, 67, 68, 'Clases de angular', 'Cuéntame un poco, qué plataforma usas, y cuando podríamos conectarnos?', '2022-02-15 19:28:54', 1, 1),
(72, 2, 67, 68, 67, 'Clases de Python', '¿Estaría bien el lunes?', '2022-02-15 19:29:07', 1, 1),
(73, 5, 69, 68, 69, 'Clases Urgentes', 'Estoy muy interesado en aprender AJAX porque mi profesor de desarrollo en cliente no tiene ni idea', '2022-02-15 19:49:37', 1, 1),
(74, 6, 69, 70, 69, 'Info clases', 'Hola diego quiero aprender de tu sabiduría', '2022-02-15 19:50:55', 1, 1),
(75, 6, 69, 70, 69, 'Info clases', 'Maquina respondes hoy o que?', '2022-02-15 19:51:44', 1, 1),
(76, 6, 70, 70, 69, 'Info clases', 'Holaaaa si hoy', '2022-02-15 19:51:57', 1, 1),
(77, 7, 71, 67, 71, 'Angular classes', 'Hi, if the language lesson is Spanish, why its writed in English?', '2022-02-16 12:20:22', 1, 1),
(78, 8, 72, 70, 72, 'Clases de modelo vista controlador', 'Oye las clases', '2022-02-16 15:21:47', 1, 1),
(79, 8, 70, 70, 72, 'Clases de modelo vista controlador', 'Hola jorge', '2022-02-16 15:22:18', 1, 1),
(80, 8, 72, 70, 72, 'Clases de modelo vista controlador', 'cuando empezamos?', '2022-02-16 15:22:32', 1, 1),
(81, 9, 69, 70, 69, 'Hola', 'Cuando tienes libre', '2022-02-17 15:11:44', 1, 1);
...
CREATE TABLE `respuestas_foro` (
  ...
  `tema_respuesta` varchar(15) NOT NULL,
  `by_respuesta` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `temas_foro` (
  ...
  `asunto_tema` varchar(20) NOT NULL,
  `fecha_tema` timestamp NOT NULL DEFAULT current_timestamp(),
  `categoria_tema` varchar(15) NOT NULL,
  `by_tema` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'prueba', '2022-04-06 13:08:18', 'general', 'diego');
...
--
ALTER TABLE `historias`
  MODIFY `id_anuncio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `mensajes`
  MODIFY `id_mensaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
