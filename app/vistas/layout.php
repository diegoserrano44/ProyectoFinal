...
<body class="bg-dark text-white">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand navTitle" href="index.php">HELP</a>
...
<footer class="bg-dark text-white d-flex flex-column-reverse flex-md-row p-4 w-100 align-items-center justify-content-between">
            <div>
                <ul class="list-group list-group-flush">
                    <h3>HELP Team</h3>
                    <li class="list-group-item listaFooter">Maria Santana</li>
                    <li class="list-group-item listaFooter">Diego Serrano</li>
                    <li class="list-group-item listaFooter">Eduard Romeu</li>
                    <li class="list-group-item listaFooter">Irene Nebot</li>
                </ul>
            </div>
            <div class="p-4">
                <a class="text-white m-3 text-decoration-none" href="">IES Abastos - 2022 - HELProgramming</a>
            </div>
